class CmsController < ApplicationController
  ...
  def certifications
    ...
    @autodesk_associate_courses = [
      ['AutoCAD', 'AutoCAD-Creative-License', 'AutoCAD', 'autodesk-autocad.png', 'Autodesk_autocad_2015_certification_exam_preparation_roadmap.pdf'],
      ['3ds-Max', '3ds-Max-Creative-License', '3DS Max', 'autodesk-3ds-max.png', 'Autodesk_3ds_max_2015_certification_exam_preparation_roadmap.pdf'],
      ['Revit', 'Revit-Architecture-101:-Rookie', 'Revit', 'autodesk-revit.png', 'Autodesk_revit_architecture_2015_certification_exam_preparation_roadmap.pdf'],
      ['Inventor', '', 'Inventor', 'autodesk-revit.png', 'Autodesk_inventor_2015_certification_exam_preparation_roadmap.pdf'],
      ['Maya', 'Maya-101:-Jumpstart:-zero-to-HERO', 'Maya', 'autodesk-maya.jpg', 'Autodesk_maya_2015_cert_exam_prep_roadmap.pdf']
    ]
